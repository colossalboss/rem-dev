...
<head>
    ...
    <link rel="stylesheet" href="css/Login page CSS style.css">
...
<body>
    <nav class="mainzone">
        <ul class="mainnav">
            <li class="link increasefont" href="index.php">RemDev</li>
...
?>
        ...
        <div class="form">
            <form class="login-form" method="post" action="">
              ...
              <p class="forgotpsw"><a class="login" href="forgotpsw.php">Forgot password</a></p>
                <p class="message">New here?  <a class="login" href="signup.php">Create Account</a></p>
            </form>
        </div>
    </div>
</body>
